...
// Vite's import.meta.glob gives us a map of lazy loaders.
...
// ── Table of contents (optional heading list) ─────────────────────────────────
// Not needed in this implementation but structure is here for future use.
...
const BlogPost = () => {
  ...
  // Lazily load the MDX module for this slug
  ...
  // Fill up to 3 from other categories if needed
  const relatedFilled =
    related.length < 3
      ? [
          ...related,
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        ...
        <div className="text-center max-w-md">
          <div className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-blue-400 to-indigo-600 mb-6 select-none">
            404
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              to="/blog"
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors text-sm font-medium"
            >
              All articles
            </Link>
          </div>
        ...
        <div className="absolute top-8 left-0 right-0 z-10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-white text-sm flex items-center gap-2">
              <Link to="/" className="hover:text-blue-300 transition-colors uppercase tracking-wide text-xs">
                Home
              </Link>
              <span className="text-gray-500">/</span>
              <Link to="/blog" className="hover:text-blue-300 transition-colors uppercase tracking-wide text-xs">
                Blog
              </Link>
              <span className="text-gray-500">/</span>
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-32">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-5">
            <span
              className={`text-xs font-bold px-3 py-1 rounded-full ${
                categoryColors[post.category] ?? 'bg-blue-100 text-blue-800'
              }`}
            >
              {post.category}
            </span>
          ...
          <div className="flex flex-wrap gap-2">
            {post.tags.map((tag) => (
              <span
                key={tag}
                className="flex items-center gap-1 text-xs text-gray-400 bg-white/10 px-3 py-1 rounded-full backdrop-blur-sm"
              >
            ...
            <div className="mt-8 bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mb-3">
                  The Velora Tech team is a group of developers, designers, and digital strategists
                  based in Sri Lanka. We build production-grade websites and web applications for
                  businesses across Asia and beyond, and write honestly about the industry from
          ...
          <aside className="lg:w-80 xl:w-96 flex-shrink-0">
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white">
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-1.5 bg-white text-blue-700 text-sm font-semibold px-4 py-2.5 rounded-xl hover:bg-blue-50 transition-colors"
                >
              ...
              <Link
                to="/blog"
                className="flex items-center justify-between w-full bg-white border border-gray-100 shadow-sm rounded-2xl px-5 py-4 text-sm font-medium text-gray-700 hover:text-blue-600 hover:border-blue-100 transition-all duration-200 group"
              >
